...
def policy_snapshot(**updates: object) -> BrokerSnapshot:
    signed = policy()
    values = {
        "total_entry_count": 0, "entry_counts_by_instrument": {contract().instrument_id: 0, "XM_MT5_US500CASH_SUPER1": 0},
        "open_position_counts_by_instrument": {contract().instrument_id: 0, "XM_MT5_US500CASH_SUPER1": 0}, "pending_order_counts_by_instrument": {contract().instrument_id: 0, "XM_MT5_US500CASH_SUPER1": 0},
