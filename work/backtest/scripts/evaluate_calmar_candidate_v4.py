...
CANDIDATE = ROOT / "research_candidates" / "v12_strategy_loop" / "nq_spx_locked_pair_calmar_risk_v1.json"
REPORT = ROOT / "outputs" / "reports" / "strategy_improvement_loop_v4" / "iteration_072" / "calmar_historical_audit_v1"
...
def main() -> None:
    ...
    selected = causal_equity_overlay(select(source), 3.0, 0.75, 1.30)
