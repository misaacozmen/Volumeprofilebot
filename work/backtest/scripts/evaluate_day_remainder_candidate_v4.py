...
from freeze_day_remainder_v4 import apply, stable_hash  # noqa: E402

SOURCE = ROOT / "outputs" / "reports" / "strategy_improvement_loop_v2" / "body_plus_classic_quota_day1_v1" / "selected_trades.csv"
CANDIDATE = ROOT / "research_candidates" / "v16_strategy_loop" / "nq_spx_locked_pair_day_remainder_v1.json"
REPORT = ROOT / "outputs" / "reports" / "strategy_improvement_loop_v4" / "iteration_087" / "day_remainder_historical_audit_v1"
