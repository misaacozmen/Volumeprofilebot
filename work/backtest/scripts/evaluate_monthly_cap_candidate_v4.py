...
from freeze_monthly_cap_v4 import CAP_R, apply, stable_hash  # noqa: E402

SOURCE = ROOT / "outputs" / "reports" / "strategy_improvement_loop_v2" / "body_plus_classic_quota_day1_v1" / "selected_trades.csv"
CANDIDATE = ROOT / "research_candidates" / "v13_strategy_loop" / "nq_spx_locked_pair_monthly_cap_v1.json"
REPORT = ROOT / "outputs" / "reports" / "strategy_improvement_loop_v4" / "iteration_076" / "monthly_cap_historical_audit_v1"
