...
REPORT = ROOT / "outputs" / "reports" / "strategy_improvement_loop_v4" / "iteration_094" / "locked_rolling_state_v1"
CANDIDATE_DIR = ROOT / "research_candidates" / "v18_strategy_loop"
PARAMETERS = {"lookback": 3, "negative_scale": 0.75, "nonnegative_scale": 1.20}
...
def main() -> None:
    ...
    payload = {
        "name": "NQ_SPX_LOCKED_PAIR_ROLLING_STATE_V1", "status": "LOCAL_LOCKED_PENDING_HISTORICAL_AUDIT",
        "base_candidate": str(BASE), "risk_rule": PARAMETERS,
        "state_rule": "sum of last 3 terminal raw R values; open trades excluded", "open_trade_outcome_used": False,
    ...
    candidate_path = CANDIDATE_DIR / "nq_spx_locked_pair_rolling_state_v1.json"
