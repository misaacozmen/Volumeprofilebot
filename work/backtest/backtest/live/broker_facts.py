    ...
    def build(
        ...
        *,
        ...
        with self.mutex():
            ...
            query_id = f"broker-read-{query_sequence}"
            read_operations = ("account_info", "positions_get", "orders_get", "history_deals_get")
            payload = {
                ...
                "broker_query_sequence": query_sequence, "broker_read_operations": read_operations,
